...
class Camera:
    def __init__(self, loc = Vec3(0, 0, 10), up = Vec3(0, 1, 0), right = Vec3(1, 0, 0),
                 dir_ = Vec3(0, 0, 1), frame_w : int = 0, frame_h : int = 0) -> None:
        """
        Создание камеры.
        Аргументы:
    ...
    def reshape(self, frame_w : int, frame_h : int) -> None:
        """
    ...
    def set(self, loc : Vec3, at : Vec3, up : Vec3 = Vec3(0, 1, 0)) -> None:
        """
        Установка камеры.
        Аргументы:
            - позиция камеры:
